    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-custom <?php echo e(request()->routeIs('products.index') ? 'active' : ''); ?>"
                        href="<?php echo e(route('products.index')); ?>">
                        <i class="fas fa-store me-2" style="font-size: 1.2rem;"></i>Shop
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-custom <?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>"
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item me-3">
                    <form class="d-flex search-form" role="search" action="<?php echo e(route('products.search')); ?>"
                        method="GET">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php if(auth()->user()->is_admin ?? false): ?>
                        <li class="nav-item">
                            <a class="nav-link admin-dashboard-link" href="<?php echo e(route('admin.dashboard')); ?>"
                ...
                <?php if(auth()->guard()->guest()): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom" href="<?php echo e(route('register')); ?>">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button"
                            ...
                            <div class="user-avatar me-2">
                                <?php if($avatarUrl): ?>
                                    <img src="<?php echo e($avatarUrlWithVersion ?? $avatarUrl); ?>" alt="User"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('userinfo')); ?>">
                ...
                <!-- Cart -->
                <li class="nav-item">
                    <a class="nav-link nav-link-custom cart-link" href="<?php echo e(route('cart.index')); ?>">
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                            ...
                            var tooltipList = tooltipTriggerList.map(function(tooltipTriggerEl) {
                                ...
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="alert-link">Go to Dashboard</a>
...
<?php /**PATH C:\Users\USER\Downloads\ABD\HeavenGift-main\HeavenGift-main\resources\views/partials/header.blade.php ENDPATH**/ ?>