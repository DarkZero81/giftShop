<div class="card product-card h-100">
    ...
    <?php else: ?>
        <div class="product-image-container">
            <img src="https://via.placeholder.com/400x300/667eea/ffffff?text=<?php echo e(urlencode($product->name)); ?>"
    ...
    <div class="card-body d-flex flex-column">
        ...
        <div class="mt-auto">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="price-tag">$<?php echo e(number_format($product->price, 2)); ?></div>
                <?php if($product->old_price ?? false): ?>
                    <div class="old-price">$<?php echo e(number_format($product->old_price, 2)); ?></div>
                <?php endif; ?>
            </div>

            <div class="d-grid gap-2">
                <a href="<?php echo e(route('products.show', $product->id)); ?>" class="btn btn-primary btn-card">
...
<?php /**PATH C:\Users\USER\Downloads\ABD\HeavenGift-main\HeavenGift-main\resources\views/partials/product_card.blade.php ENDPATH**/ ?>