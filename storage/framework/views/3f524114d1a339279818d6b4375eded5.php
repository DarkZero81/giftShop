            ...
            <div class="col-lg-10 col-xl-8">
                <div class="profile-container">
                    ...
                    <div class="profile-header">
                        <img src="<?php echo e($user->profile_photo_url ?? 'https://via.placeholder.com/150?text=User'); ?>"
                            alt="Profile Image" class="rounded-circle profile-image"
                            style="width: 150px; height: 150px; object-fit: cover;">

                        <h2 class="section-title mt-3"><?php echo e($user->name); ?></h2>
                    ...
                    <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="profile_image_url"
                                        name="profile_image_url" value="<?php echo e(old('profile_image_url')); ?>"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control"
                                        value="<?php echo e($user->created_at->format('Y-m-d')); ?>" readonly>
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Last Updated</label>
                                    <input type="text" class="form-control"
                                        value="<?php echo e($user->updated_at->format('Y-m-d H:i')); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            <a href="<?php echo e(url()->previous()); ?>" class="btn-secondary-custom me-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Downloads\ABD\HeavenGift-main\HeavenGift-main\resources\views/profile.blade.php ENDPATH**/ ?>