<?php $__env->startSection('content'); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="h3 mb-0 font-weight-bold text-white counter"
                                data-target="<?php echo e($stats['total_users']); ?>">0</div>
                ...
                <div class="card-body text-white p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="h3 mb-0 font-weight-bold text-white counter"
                                data-target="<?php echo e($stats['total_revenue']); ?>" data-prefix="$">0</div>
                            <div class="text-xs text-white mt-1 opacity-90 growth-indicator">
                ...
                <div class="card-body text-white p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="h3 mb-0 font-weight-bold text-white counter"
                                data-target="<?php echo e($stats['total_orders']); ?>">0</div>
                            <div class="text-xs text-white mt-1 opacity-90 growth-indicator">
                ...
                <div class="card-body text-white p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="h3 mb-0 font-weight-bold text-white counter"
                                data-target="<?php echo e($stats['total_products']); ?>">0</div>
                            <div class="text-xs text-white mt-1 opacity-90 growth-indicator">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4 glass-card">
                ...
                <div class="card-body">
                    <?php $__currentLoopData = $stats['top_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex align-items-center mb-3 product-item" data-aos="fade-up">
                            ...
                            <div class="flex-grow-1">
                                <div class="small font-weight-bold product-name"><?php echo e(Str::limit($product->name, 15)); ?></div>
                                <div class="text-xs text-muted order-count"><?php echo e($product->order_items_count ?? 0); ?> orders
                                </div>
                            </div>
                    ...
                    <?php if($stats['top_products']->isEmpty()): ?>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow glass-card">
                ...
                <div class="card-body">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $stats['recent_orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="order-row">
                                        ...
                                        <td class="customer-name"><?php echo e($order->user->name ?? 'Guest'); ?></td>
                                        <td class="order-amount">$<?php echo e(number_format($order->total ?? 0, 2)); ?></td>
                                        <td>
                                            <span
                    ...
                    <?php if($stats['recent_orders']->isEmpty()): ?>
                        <div class="text-center text-muted py-3">
                            <i class="bi bi-info-circle"></i>
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-sm btn-outline-primary animated-btn">
                            View All Orders
                        </a>
                    </div>
                </div>
                            ...
                            <div class="card border-0 mb-3 overflow-hidden position-relative stat-card"
                                ...
                                <div class="card-body py-3 text-white">
                                    <div class="h4 mb-0 font-weight-bold counter"
                                        data-target="<?php echo e($stats['monthly_sales']); ?>" data-prefix="$">0</div>
    ...
    <script>
        ...
        let salesChart = new Chart(ctx, {
            ...
            data: {
                labels: [
                    <?php $__currentLoopData = $salesChart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Downloads\ABD\HeavenGift-main\HeavenGift-main\resources\views/admin/analytics/index.blade.php ENDPATH**/ ?>