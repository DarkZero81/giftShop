            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse rounded-3 fs-4">
                ...
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(Request::is('admin/coupons*') ? 'active' : ''); ?>"
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(Request::is('admin/payments*') ? 'active' : ''); ?>"
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(Request::is('admin/analytics*') ? 'active' : ''); ?>"
                    ...
                    <ul class="nav flex-column mb-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/userinfo')); ?>" target="_blank">
...
<?php /**PATH C:\Users\USER\Downloads\ABD\HeavenGift-main\HeavenGift-main\resources\views/layouts/admin.blade.php ENDPATH**/ ?>