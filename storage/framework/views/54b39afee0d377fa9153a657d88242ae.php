<?php $__env->startSection('content'); ?>
            ...
            <div class="row mb-4">
                    ...
                    <div class="stat-card" style="background: #17a2b8;">
                        <div class="stat-card-content">
                            <div class="stat-card-header">
                                <h2><?php echo e($reviews->total()); ?></h2>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="stat-card" style="background: #28a745;">
                        <div class="stat-card-content">
                            <div class="stat-card-header">
                                <h2><?php echo e($reviews->where('approved', true)->count()); ?></h2>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="stat-card" style="background: #ffc107;">
                        <div class="stat-card-content">
                            <div class="stat-card-header">
                                <h2><?php echo e($reviews->where('approved', false)->count()); ?></h2>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="stat-card" style="background: #6f42c1;">
                        <div class="stat-card-content">
                            <div class="stat-card-header">
                                <h2><?php echo e(number_format($reviews->avg('rating'), 1)); ?></h2>
                            </div>
                            ...
                            <form method="GET" action="<?php echo e(route('admin.reviews.index')); ?>">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="rating" onchange="this.form.submit()">
                                        ...
                                        <option value="5" <?php echo e(request('rating') == '5' ? 'selected' : ''); ?>>5 Stars
                                        </option>
                                        <option value="4" <?php echo e(request('rating') == '4' ? 'selected' : ''); ?>>4 Stars
                                        </option>
                                        <option value="3" <?php echo e(request('rating') == '3' ? 'selected' : ''); ?>>3 Stars
                                        </option>
                                        <option value="2" <?php echo e(request('rating') == '2' ? 'selected' : ''); ?>>2 Stars
                                        </option>
                                        <option value="1" <?php echo e(request('rating') == '1' ? 'selected' : ''); ?>>1 Star
                                        </option>
                                    </select>
                                </div>
                            </form>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <span class="badge bg-secondary">#<?php echo e($review->id); ?></span>
                                            </td>
                                            <td>
                                                <?php if($review->product): ?>
                                                    <div class="d-flex align-items-center">
                                                        <?php if($review->product->image): ?>
                                                            <img src="<?php echo e(asset($review->product->image)); ?>"
                                                                alt="<?php echo e($review->product->name); ?>" class="rounded me-2"
                                                        ...
                                                        <div>
                                                            ...
                                                            <br>
                                                            <small
                                                                class="text-muted">$<?php echo e(number_format($review->product->price, 2)); ?></small>
                                                        </div>
                                                    </div>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="text-warning me-2">
                                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                                            <i
                                                                class="bi bi-star<?php echo e($i <= $review->rating ? '-fill' : ''); ?>"></i>
                                                        <?php endfor; ?>
                                                    </div>
                                                    <span class="badge bg-primary"><?php echo e($review->rating); ?>/5</span>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <?php if(!$review->approved): ?>
                                                        <form action="<?php echo e(route('admin.reviews.update', $review)); ?>"
    ...
    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="modal fade" id="reviewModal<?php echo e($review->id); ?>" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Review Details #<?php echo e($review->id); ?></h5>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php if($review->product): ?>
                                    <div class="d-flex align-items-center mb-3">
                                        <?php if($review->product->image): ?>
                                            <img src="<?php echo e(asset('Photo/' . $review->product->image)); ?>"
                                                alt="<?php echo e($review->product->name); ?>" class="rounded me-3"
                                                style="width: 80px; height: 80px; object-fit: cover;">
                                        <?php endif; ?>
                                        <div>
                                            <h6 class="mb-1"><?php echo e($review->product->name); ?></h6>
                                            <p class="mb-0 text-muted">$<?php echo e(number_format($review->product->price, 2)); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php if($review->user): ?>
                                    <div>
                                        ...
                                        <p class="mb-1 text-muted"><?php echo e($review->user->email); ?></p>
                                        <p class="mb-0 text-muted">Member since
                                            <?php echo e($review->user->created_at->format('M Y')); ?></p>
                                    </div>
                                <?php else: ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <h6>Date</h6>
                                <p class="mb-0"><?php echo e($review->created_at->format('F d, Y \a\t H:i')); ?></p>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Downloads\ABD\HeavenGift-main\HeavenGift-main\resources\views/admin/reviews/index.blade.php ENDPATH**/ ?>