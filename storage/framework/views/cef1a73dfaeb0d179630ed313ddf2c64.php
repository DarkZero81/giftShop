                ...
                <div class="row align-items-center">
                        ...
                        <div class="product-image-section">
                            <?php if($product->image): ?>
                                ...
                                <?php if(filter_var($img, FILTER_VALIDATE_URL)): ?>
                                    <img src="<?php echo e($img); ?>" class="product-image-unified" alt="<?php echo e($product->name); ?>">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('storage/' . $img)); ?>" class="product-image-unified"
                    ...
                    <div class="col-md-6">
                        <div class="product-info-section">
                            <h2 class="product-title-unified"><?php echo e($product->name); ?></h2>
                            <p class="text-muted"><?php echo e($product->category->name ?? 'Uncategorized'); ?></p>
                            <div class="product-price-unified">$<?php echo e(number_format($product->price, 2)); ?></div>
                            <p class="product-description-unified"><?php echo e($product->description); ?></p>
            ...
            <div class="card-body p-4">
                <div class="row mb-4">
                    <div class="col-md-4 text-center">
                        <h2 class="text-primary"><?php echo e(number_format($averageRating, 1)); ?></h2>
                        <div class="rating-display mb-2">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <i
                                    class="bi bi-star<?php echo e($i <= floor($averageRating) ? '-fill' : ($i <= $averageRating ? '-half' : '')); ?>"></i>
                            <?php endfor; ?>
                        </div>
                        <p class="text-muted">Based on <?php echo e($reviewsCount); ?> Ratings</p>
                    </div>
                    <div class="col-md-8">
                        <?php for($i = 5; $i >= 1; $i--): ?>
                            <?php
                            ...
                            <div class="row align-items-center mb-2">
                                <div class="col-2">
                                    <small class="text-muted"><?php echo e($i); ?> <i
                                ...
                                <div class="col-8">
                                    <div class="progress" style="height: 8px;" role="progressbar"
                                        ...
                                        aria-label="<?php echo e($i); ?> star ratings - <?php echo e(number_format($percentage, 1)); ?>%">
                                        <div class="progress-bar bg-warning" style="width: <?php echo e($percentage); ?>%"></div>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <small class="text-muted">(<?php echo e($ratingCounts[$i]); ?>)</small>
                                </div>
                            </div>
                        <?php endfor; ?>
                    </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $approvedReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="review-item">
                            <div class="reviewer-info">
                                ...
                                <div>
                                    <h6 class="mb-1" style="color: #2196f3"><?php echo e($review->user->name ?? 'مستخدم محذوف'); ?>
                                ...
                                <small class="text-muted ms-auto"><?php echo e($review->created_at->diffForHumans()); ?></small>
                            </div>
                            <div class="comment-text"><?php echo e($review->comment); ?></div>
                        </div>
                        ...
                        <form action="<?php echo e(route('reviews.store', $product)); ?>" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="rating-stars">
                                    <?php for($i = 5; $i >= 1; $i--): ?>
                                        <div class="rating">
                                            <input value="<?php echo e($i); ?>" <?php echo e($i == 5 ? 'checked' : ''); ?> name="rating"
                                                id="star<?php echo e($i); ?>" type="radio">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        <a href="<?php echo e(route('login')); ?>" class="alert-link"> Sign In</a> To Add You Comment .
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Downloads\ABD\HeavenGift-main\HeavenGift-main\resources\views/products/show.blade.php ENDPATH**/ ?>